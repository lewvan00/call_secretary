...
package amazonaws.mobileconnectors.lex.interactionkit;
...
import android.audio.encoder.OpusEncoder;
...
import amazonaws.mobileconnectors.lex.interactionkit.exceptions.AudioPlaybackException;
import amazonaws.mobileconnectors.lex.interactionkit.exceptions.DialogFailedException;
import amazonaws.mobileconnectors.lex.interactionkit.exceptions.InvalidParameterException;
import amazonaws.mobileconnectors.lex.interactionkit.exceptions.LexClientException;
import amazonaws.mobileconnectors.lex.interactionkit.exceptions.NoSpeechTimeOutException;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecorder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTaskListener;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.LexAudioRecorder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.LexAudioRecorderBuilder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.BufferedAudioEncoder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.L16PcmEncoder;
import amazonaws.mobileconnectors.lex.interactionkit.internal.vad.config.DnnVADConfig;
import amazonaws.mobileconnectors.lex.interactionkit.listeners.AudioPlaybackListener;
import amazonaws.mobileconnectors.lex.interactionkit.utils.AudioEncoding;
import amazonaws.mobileconnectors.lex.interactionkit.utils.CreateLexServiceRequest;
import amazonaws.mobileconnectors.lex.interactionkit.utils.ResponseType;
import com.amazonaws.regions.Region;
import com.amazonaws.regions.Regions;
import amazonaws.services.lexrts.AmazonLexRuntime;
import amazonaws.services.lexrts.model.DialogState;
import amazonaws.services.lexrts.model.PostContentRequest;
import amazonaws.services.lexrts.model.PostContentResult;
...
public class InteractionClient {
     ...
     */
    private amazonaws.mobileconnectors.lex.interactionkit.listeners.InteractionListener interactionListener;
     ...
     */
    private amazonaws.mobileconnectors.lex.interactionkit.listeners.MicrophoneListener microphoneListener;
     ...
     */
    private amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioTimeouts audioTimeouts;
    ...
    public InteractionClient(Context context,
        ...
        this.interactionListener = new amazonaws.mobileconnectors.lex.interactionkit.listeners.DefaultInteractionListener();
        ...
        amazonlex = new amazonaws.services.lexrts.AmazonLexRuntimeClient(credentialsProvider, clientConfiguration);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    audioTimeouts = new amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioTimeouts(interactionConfig.getNoSpeechTimeoutInterval(),
     ...
     * {@link amazonaws.mobileconnectors.lex.interactionkit.listeners.InteractionListener} object.
     *
     * @param handler {@link Handler}, to interact with app components in the
     *            main thread.
     * @param result {@link PostContentResult}, response from the Amazon Lex
     ...
     * @param handler {@link Handler}, to interact with app components in the
     *            main thread.
     * @param microphoneListener {@link amazonaws.mobileconnectors.lex.interactionkit.listeners.MicrophoneListener}, callback to
    ...
    private void startListening(final Handler handler,
                                final amazonaws.mobileconnectors.lex.interactionkit.listeners.MicrophoneListener microphoneListener,
            final LexAudioRecorder lexAudioRecorder,
                                final PostContentRequest request,
                                final InteractionClient client,
                                final ResponseType mode) {
        final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTask recordingTask = new amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTask(lexAudioRecorder,
            ...
            public void onMaxSpeechTimeout() {
                ...
                if (microphoneListener != null) {
                    final Runnable appCallBack = new Runnable() {
                        ...
                        public void run() {
                            microphoneListener.onMicrophoneError(
                                    new amazonaws.mobileconnectors.lex.interactionkit.exceptions.MaxSpeechTimeOutException(
     ...
     */
    public void setMicrophoneListener(amazonaws.mobileconnectors.lex.interactionkit.listeners.MicrophoneListener microphoneListener) {
     ...
     * @param interactionListener the interaction listener {@link amazonaws.mobileconnectors.lex.interactionkit.listeners.InteractionListener}.
     */
    public void setInteractionListener(amazonaws.mobileconnectors.lex.interactionkit.listeners.InteractionListener interactionListener) {
        if (interactionListener == null) {
            // use the default implementation
            interactionListener = new amazonaws.mobileconnectors.lex.interactionkit.listeners.DefaultInteractionListener();
        }
