...
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTask.AudioRecordingTaskState;

import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.common.Progress;
...
public class AudioRecordingTask extends AsyncTask<Void, Progress<AudioRecordingTaskState>, Void> {
    ...
    private final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTaskListener mListener;
     ...
     */
    public AudioRecordingTask(final AudioRecorder audioRecorder, final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioRecordingTaskListener listener) {
     ...
     */
    @SuppressWarnings("unchecked")
    private class AudioRecorderListener implements amazonaws.mobileconnectors.lex.interactionkit.internal.audio.AudioSourceListener {
