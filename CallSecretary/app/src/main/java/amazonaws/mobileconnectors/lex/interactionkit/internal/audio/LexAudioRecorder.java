...
package amazonaws.mobileconnectors.lex.interactionkit.internal.audio;
...
public class LexAudioRecorder extends AudioRecorder implements ChunkedAudioSource {
     ...
     */
    private final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoder mAudioEncoder;
    /**
     * Voice Activity Detector instance.
     */
    private final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector mVAD;
    /**
     * Stream timeout.
     */
     ...
     */
    private amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState state;

    /**
     * The state of the audio recorder after recording a sample.
     */
    private amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState currentState;
     ...
     */
    LexAudioRecorder(final Context context, final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoder audioEncoder,
                     final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector vad, final AudioTimeouts audioTimeouts,
     ...
     * @throws Exception if failed to create audio recorder instance.
     */
    protected LexAudioRecorder(final Context context, final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoder audioEncoder,
                               final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector vad, final AudioTimeouts audioTimeouts,
     ...
     * @throws Exception if failed to create audio recorder instance.
     */
    public LexAudioRecorder(final Context context, final amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoder audioEncoder,
                            final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector vad, final AudioTimeouts audioTimeouts,
                            final int numSamplesPerRead, final int recorderPositionNotificationPeriod,
    ...
    public void startRecording() throws Exception {
        state = amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.NOT_STARTPOINTED;
    ...
    protected boolean isInValidStateToContinueRecording() {
        return !isCancelled() && state != amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.ENDPOINTED;
    }
    ...
    protected void postAudioRecordingProcessing(final int numSamplesRead,
        ...
        if (state == amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.NOT_STARTPOINTED) {
            if (currentState == amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.STARTPOINTED) {
        ...
        } else if (state == amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.STARTPOINTED) {
            if (currentState == amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState.ENDPOINTED) {
     ...
     * @return the state.
     */
    amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState getState() {
        return state;
    }
     ...
     */
    amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState getCurrentState() {
        return currentState;
    }
     ...
     */
    void setState(final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState testState) {
        state = testState;
    }
     ...
     */
    void setCurrentState(final amazonaws.mobileconnectors.lex.interactionkit.internal.vad.VoiceActivityDetector.VADState testCurrentState) {
