...
import amazonaws.mobileconnectors.lex.interactionkit.internal.audio.encoder.AudioEncoderException;
...
public final class LexAudioRecorderBuilder {
     ...
     */
    public amazonaws.mobileconnectors.lex.interactionkit.internal.audio.LexAudioRecorder build() throws Exception {
        final android.vad.AbstractVAD<?> vad = new amazonaws.mobileconnectors.lex.interactionkit.internal.vad.DnnVAD(AudioRecorder.DEFAULT_SAMPLE_RATE, mDnnVADConfig);
        return new amazonaws.mobileconnectors.lex.interactionkit.internal.audio.LexAudioRecorder(mContext, mAudioEncoder, vad, mAudioTimeouts,
