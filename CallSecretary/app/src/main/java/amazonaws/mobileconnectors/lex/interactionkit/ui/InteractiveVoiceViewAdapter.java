...
package amazonaws.mobileconnectors.lex.interactionkit.ui;
...
public class InteractiveVoiceViewAdapter
        implements amazonaws.mobileconnectors.lex.interactionkit.listeners.InteractionListener, AudioPlaybackListener, amazonaws.mobileconnectors.lex.interactionkit.listeners.MicrophoneListener,
    ...
    private amazonaws.mobileconnectors.lex.interactionkit.InteractionClient lexInteractionClient;
    private amazonaws.mobileconnectors.lex.interactionkit.continuations.LexServiceContinuation continuation;
    ...
    @Override
    public void onReadyForFulfillment(amazonaws.mobileconnectors.lex.interactionkit.Response response) {
    ...
    @Override
    public void promptUserToRespond(amazonaws.mobileconnectors.lex.interactionkit.Response response,
                                    amazonaws.mobileconnectors.lex.interactionkit.continuations.LexServiceContinuation continuation) {
        if (response == null) {
            Log.e(TAG, "InteractiveVoiceViewAdapter: Received null response from Amazon Lex bot");
        }

        if (amazonaws.services.lexrts.model.DialogState.Fulfilled.toString().equals(response.getDialogState())) {
    ...
    @Override
    public void onInteractionError(amazonaws.mobileconnectors.lex.interactionkit.Response response, Exception e) {
    ...
    public void onMicrophoneError(Exception e) {
        micButton.animateNone();
        if (e instanceof amazonaws.mobileconnectors.lex.interactionkit.exceptions.NoSpeechTimeOutException) {
            Log.e(TAG, "InteractiveVoiceViewAdapter: Failed to detect speech", e);
            state = STATE_READY;
        } else if (e instanceof amazonaws.mobileconnectors.lex.interactionkit.exceptions.MaxSpeechTimeOutException) {
    ...
    protected void validateAppData() {
        if (interactionConfig == null) {
            throw new amazonaws.mobileconnectors.lex.interactionkit.exceptions.InvalidParameterException(
    ...
    protected void createInteractionClient() {
        ...
        lexInteractionClient = new amazonaws.mobileconnectors.lex.interactionkit.InteractionClient(
                context,
                credentialsProvider,
                awsRegion,
                interactionConfig,
