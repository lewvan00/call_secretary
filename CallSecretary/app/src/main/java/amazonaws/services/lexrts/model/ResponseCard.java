...
package amazonaws.services.lexrts.model;
...
public class ResponseCard implements Serializable {
     ...
     * </p>
     */
    private java.util.List<amazonaws.services.lexrts.model.GenericAttachment> genericAttachments;
     ...
     *         </p>
     */
    public java.util.List<amazonaws.services.lexrts.model.GenericAttachment> getGenericAttachments() {
     ...
     *            </p>
     */
    public void setGenericAttachments(java.util.Collection<amazonaws.services.lexrts.model.GenericAttachment> genericAttachments) {
        if (genericAttachments == null) {
            this.genericAttachments = null;
            return;
        }

        this.genericAttachments = new java.util.ArrayList<amazonaws.services.lexrts.model.GenericAttachment>(genericAttachments);
    }
     ...
     *         chained together.
     */
    public ResponseCard withGenericAttachments(amazonaws.services.lexrts.model.GenericAttachment... genericAttachments) {
        if (getGenericAttachments() == null) {
            this.genericAttachments = new java.util.ArrayList<amazonaws.services.lexrts.model.GenericAttachment>(
                    genericAttachments.length);
        }
        for (amazonaws.services.lexrts.model.GenericAttachment value : genericAttachments) {
    ...
    public ResponseCard withGenericAttachments(
            java.util.Collection<amazonaws.services.lexrts.model.GenericAttachment> genericAttachments) {
