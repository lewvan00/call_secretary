...
public class BadRequestExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public BadRequestExceptionUnmarshaller() {
        super(amazonaws.services.lexrts.model.BadRequestException.class);
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        amazonaws.services.lexrts.model.BadRequestException e = (amazonaws.services.lexrts.model.BadRequestException) super.unmarshall(error);
