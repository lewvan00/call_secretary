...
public class ConflictExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public ConflictExceptionUnmarshaller() {
        super(amazonaws.services.lexrts.model.ConflictException.class);
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        amazonaws.services.lexrts.model.ConflictException e = (amazonaws.services.lexrts.model.ConflictException) super.unmarshall(error);
