...
class GenericAttachmentJsonMarshaller {
    ...
    public void marshall(amazonaws.services.lexrts.model.GenericAttachment genericAttachment, AwsJsonWriter jsonWriter)
            throws Exception {
        ...
        if (genericAttachment.getButtons() != null) {
            java.util.List<amazonaws.services.lexrts.model.Button> buttons = genericAttachment.getButtons();
            jsonWriter.name("buttons");
            jsonWriter.beginArray();
            for (amazonaws.services.lexrts.model.Button buttonsItem : buttons) {
                if (buttonsItem != null) {
