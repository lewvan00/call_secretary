...
class GenericAttachmentJsonUnmarshaller implements
        Unmarshaller<amazonaws.services.lexrts.model.GenericAttachment, JsonUnmarshallerContext> {

    public amazonaws.services.lexrts.model.GenericAttachment unmarshall(JsonUnmarshallerContext context) throws Exception {
        AwsJsonReader reader = context.getReader();
        if (!reader.isContainer()) {
            reader.skipValue();
            return null;
        }
        amazonaws.services.lexrts.model.GenericAttachment genericAttachment = new amazonaws.services.lexrts.model.GenericAttachment();
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (name.equals("title")) {
                ...
                genericAttachment.setButtons(new ListUnmarshaller<amazonaws.services.lexrts.model.Button>(ButtonJsonUnmarshaller
                        .getInstance()
                        )
                                .unmarshall(context));
            } else {
