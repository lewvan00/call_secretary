...
public class InternalFailureExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public InternalFailureExceptionUnmarshaller() {
        super(amazonaws.services.lexrts.model.InternalFailureException.class);
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        amazonaws.services.lexrts.model.InternalFailureException e = (amazonaws.services.lexrts.model.InternalFailureException) super.unmarshall(error);
