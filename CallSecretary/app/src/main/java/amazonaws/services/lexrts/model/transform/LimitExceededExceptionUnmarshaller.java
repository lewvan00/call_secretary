...
public class LimitExceededExceptionUnmarshaller extends JsonErrorUnmarshaller {
    ...
    public LimitExceededExceptionUnmarshaller() {
        super(amazonaws.services.lexrts.model.LimitExceededException.class);
    }
    ...
    public AmazonServiceException unmarshall(JsonErrorResponse error) throws Exception {
        ...
        amazonaws.services.lexrts.model.LimitExceededException e = (amazonaws.services.lexrts.model.LimitExceededException) super.unmarshall(error);
