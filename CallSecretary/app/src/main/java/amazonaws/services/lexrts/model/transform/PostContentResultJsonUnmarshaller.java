...
public class PostContentResultJsonUnmarshaller implements
        Unmarshaller<amazonaws.services.lexrts.model.PostContentResult, JsonUnmarshallerContext> {

    @Override
    public amazonaws.services.lexrts.model.PostContentResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        final amazonaws.services.lexrts.model.PostContentResult postContentResult = new amazonaws.services.lexrts.model.PostContentResult();
