...
public class PostTextRequestMarshaller implements
        Marshaller<Request<amazonaws.services.lexrts.model.PostTextRequest>, amazonaws.services.lexrts.model.PostTextRequest> {

    public Request<amazonaws.services.lexrts.model.PostTextRequest> marshall(amazonaws.services.lexrts.model.PostTextRequest postTextRequest) {
        if (postTextRequest == null) {
            throw new AmazonClientException("Invalid argument passed to marshall(PostTextRequest)");
        }

        Request<amazonaws.services.lexrts.model.PostTextRequest> request = new DefaultRequest<amazonaws.services.lexrts.model.PostTextRequest>(postTextRequest,
                "AmazonLexRuntime");
