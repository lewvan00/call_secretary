...
public class PostTextResultJsonUnmarshaller implements
        Unmarshaller<amazonaws.services.lexrts.model.PostTextResult, JsonUnmarshallerContext> {

    public amazonaws.services.lexrts.model.PostTextResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        amazonaws.services.lexrts.model.PostTextResult postTextResult = new amazonaws.services.lexrts.model.PostTextResult();
