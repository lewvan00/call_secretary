...
class ResponseCardJsonMarshaller {
    ...
    public void marshall(amazonaws.services.lexrts.model.ResponseCard responseCard, AwsJsonWriter jsonWriter) throws Exception {
        ...
        if (responseCard.getGenericAttachments() != null) {
            java.util.List<amazonaws.services.lexrts.model.GenericAttachment> genericAttachments = responseCard
                    .getGenericAttachments();
            jsonWriter.name("genericAttachments");
            jsonWriter.beginArray();
            for (amazonaws.services.lexrts.model.GenericAttachment genericAttachmentsItem : genericAttachments) {
